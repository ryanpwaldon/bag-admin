  ...
  <div v-else>
    <div class="overflow-hidden bg-white divide-y divide-gray-200 rounded-lg shadow">
      <div class="px-4 py-5 sm:p-6">
        <h2 class="text-lg font-medium leading-6 text-gray-800">{{ progressBar?.title }}</h2>
...
const links: Link[] = [
  ...
  { title: 'Edit', name: 'progress-bar-edit', icon: Pencil }
]
...
export default defineComponent({
  ...
  setup(props) {
    ...
    return { progressBar, loading, links }
  }
})
</script>
