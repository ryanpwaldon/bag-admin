<template>
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="text-yellow-400">
    <path
      fill="currentColor"
    ...
    />
    <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M15 5v2" />
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11v2M15 17v2" />
  </svg>
</template>
